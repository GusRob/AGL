...
int main( int argc, char* argv[] ) {
	...
	pWindow = new AGL::Window_c(C_WIDTH, C_HEIGHT, "Example Program 4: Lighting", MoveObject);

	pScene = new AGL::Scene_c(*pWindow);

	ObjectIndex = pScene->AddObjectFromFile("examples/assets/sponza/sponza.obj");
	pScene->SetObjectScale(ObjectIndex, simd::float3(1));
