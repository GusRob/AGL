...
namespace MTK
{
	...
	class TextureLoader : public NS::Referencing< TextureLoader >
	{
		public:
			...
			MTL::Texture* 				newTexture(const NS::Data* pData, const NS::Dictionary* pOptions, NS::Error** pError);
...
_NS_INLINE MTL::Texture* MTK::TextureLoader::newTexture(const NS::Data* pData, const NS::Dictionary* pOptions, NS::Error** pError)
{
	return NS::Object::sendMessage<MTL::Texture*>(this, _MTK_PRIVATE_SEL(newTextureWithData_options_error_), pData, pOptions, pError);
}
